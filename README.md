...
* [ ] Replace line 1 of this document (`README.md`) with your first name and last initial.

### Lessons

* [ ] Read `Lesson 01 - Set Up Instructions.md`.
* [ ] Read `Lesson 02 - The Main Loop.md`.
* [ ] Read `Lesson 03 - Inputs - Buttons.md`.
* [ ] Read `Lesson 04 - Inputs - Switch.md`.
* [ ] Read `Lesson 05 - Inputs - Capacitive Touch.md`.
* [ ] Read `Lesson 06 - Inputs - Light Sensor.md`.
* [ ] Read `Lesson 07 - Inputs - Accelerometer.md`.
* [ ] Read `Lesson 08 - Inputs - Temperature.md`.
* [ ] Read `Lesson 09 - Inputs - Microphone.md`.
* [ ] Read `Lesson 10 - Inputs - IR Transciever.md`.
* [ ] Read `Lesson 11 - Outputs - Builtin LED.md`.
* [ ] Read `Lesson 12 - Outputs - Speaker.md`.
* [ ] Read `Lesson 13 - Outputs - Neopixels.md`.
